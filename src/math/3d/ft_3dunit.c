...
/*   Updated: 2026/03/14 17:24:58 by jaicastr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
inline t_8packd	ft_3dclampsum8(t_3dcoordsx8 c)
{
	...
	v[0] = *(const t_v8da * restrict const) & c.a;
	v[1] = *(const t_v8da * restrict const) & c.c;
	v[2] = *(const t_v8da * restrict const) & c.e;
	v[3] = *(const t_v8da * restrict const) & c.g;
	return ((t_8packd)
		{
			.x = v[0][0] + v[0][1] + v[0][2],
			.y = v[0][4] + v[0][5] + v[0][6],
