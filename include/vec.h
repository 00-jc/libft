...
void			*ft_vec_get_last(const t_vec *restrict const vec,\
					size_t type_size)\
					__attribute__((__nonnull__(1), pure));

const void		*ft_vec_peek_last(const t_vec *restrict const vec,\
...
int				ft_vec_remove(t_vec *restrict const v, size_t i,\
					size_t type_size) __attribute__((__nonnull__(1)));

int				ft_vec_removef(t_vec *restrict const v, size_t i,\
